                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title" style="margin-bottom: 10px">sub category</h3>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <button class="btn btn-primary btn-block" id="form-btn"><i class="fa fa-edit"></i> edit order</button>
                    ...
                    @if ($client->orders->count() > 0)
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="margin-bottom: 10px">previous orders
