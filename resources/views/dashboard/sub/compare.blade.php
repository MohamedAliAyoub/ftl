                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <section class="search-section">
                                            @foreach($other_quotes->map(function($item){
                                            return $item['items']->mapWithKeys(function($i)use($item){
                                                return ['id_'.$item['key']->id . '_' . $i->id => $i];
                                            });
                                        })->collapse()->unique('id') as $key => $sub)
                                                <article>
                                                    <div class="box-content MakeRequestBoxcontent mt-3 fadeIn">
                                                        ...
                                                        <div class="PriceBook">
                                                            ...
                                                            <?php $id =  explode('_', $key)[1]  ?>
                                                            <div class="CollapseRow">
                                                                <a href="{{route('sub.edit',$id)}} "
                                                                   class="BookBtn">
                                                                    Edit
                                                                </a>
